...
//echo "Connected successfully";
  ...
  $result -> free_result();
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk kiralamaya kapalı olmadığı için bu menüden işlem yapılamaz. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KİRAYA KAPALI MÜLK DEĞERLENDİRME SAYFASI</label>
    ...
    $counter++;
          ...
          <div class="row">
           ...
           <div class="row">
            ...
            <br>
          <hr>
        <form  id="busers" action="/kirakapalimulkyonetdegaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
           <input type="text" id="mulkno" name="mulkno" class="form-control" value="<?php echo $mulkno;?>" required="required" style="display:none;">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Kiraya Kapalı Mülkün Yeniden Kiraya Açılacağı Tarihi Giriniz *</label>
            </div>
            <div class="col-75">
              <input type="date" id="mulkkiraacmatarihi" name="mulkkiraacmatarihi" style="font-weight:bolder" required="required" min="<?php echo date('Y-m-d'); ?>" >
            </div>
          </div>
          <hr>
            <br>
            <br>
          <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Onayla">
          </div>
        </form>
