...
//echo "Connected successfully";
  ...
  $result -> free_result();
    ...
    if($kiralamaonayinda==2 || $kiralandi==1){
        echo "<br>";
        echo "<br>";
   echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülkün kiralama işlemi onaylanmıştır. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
   mysqli_close($conn);            
   exit();   
  }  
    
      if($kiralamaonayinda==0){
        echo "<br>";
        echo "<br>";
   echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülkün kiralama işlemi bulunmamaktadır. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
   mysqli_close($conn);            
   exit();   
  }  
...
//echo "Connected successfully"; 
          if($kirakaporaeklendi==1){
              $sql = "UPDATE mulkkayit SET kiralamaonayinda=0,kiralamaguncellemegonderildi=0 where id='$mulknoid'"; 
          }
            else{
                $sql = "UPDATE mulkkayit SET kiralamaonayinda=0,kiralamaguncellemegonderildi=0 kirakaporasonkey=''  where id='$mulknoid'";  
            }
     ...
     if ($conn->query($sql) === TRUE) {
         ...
         $sql = "DELETE FROM kiralamakayit where kiralamakey='$kirakaporasonkey'"; 
         
         if ($conn->query($sql) === TRUE) {
         echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Kiralama Kaydı Verileri Silinmiştir. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>';
         }
         else 
{
