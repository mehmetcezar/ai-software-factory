...
$yonetimsozlesmesi= mysqli_real_escape_string($conn, $yonetimsozlesmesi); 
     ...
     /*$sql = "UPDATE yapikayit SET ulke='$ulke', ilce='$ilce', mahalle='$mahalle', sokak='$sokak',projeadi='$projeadi',siteadi='$siteadi',blok='$blok',kat='$kat',kapino='$kapino',mulktip1='$mulktip1',mulktip2='$mulktip2', postakodu='$postakodu', cephe='$cephe', alan='$alan', salonadet='$salonadet', odaadet='$odaadet', banyoadet='$banyoadet', gunusername='$uname', gundate='$date' where yapikayit.yapino='$yapino'";*/
    
     $sql = "UPDATE yapikayit SET ulke='$ulke', ilce='$ilce', mahalle='$mahalle', sokak='$sokak',projeadi='$projeadi',siteadi='$siteadi',blok='$blok',kat='$kat',kapino='$kapino',mulktip1='$mulktip1', postakodu='$postakodu', cephe='$cephe', alan='$alan', salonadet='$salonadet', odaadet='$odaadet', banyoadet='$banyoadet', yonetimsozlesmesi='$yonetimsozlesmesi', gunusername='$uname', gundate='$date' where yapikayit.yapino='$yapino'";
    ...
    if ($conn->query($sql) === TRUE) {
       ...
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">'.$yapino.' numaralı yapı başarıyla güncellenmiştir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>';
