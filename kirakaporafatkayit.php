...
<br>
    ...
    <div class="options">
      <div class="container"> 
          ...
          <?php
              ...
              echo '<label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">YÜKLENEN FATURAYI GÖR/İNDİR</label>';
               }
              ?>
          </div>
    ...
    echo '<div class="row">
            <div class="col-25">
              <label for="kaporafatbelge" style="font-weight:bolder">Kapora Faturası </label>
            </div>
               <div class="col-75">';
...
echo '<label>'.$counter.'-'.'Kapora Faturası</label>';
    echo '<br>';
echo '<a href="?dosya='.$kaporakirabelgex.'">Dosyayı İndir</a>';
    ...
    $counter++;      
          ...
          <form  id="busers" action="/kirakaporafatkayitaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"> 
          ...
          <div class="row">
            <div class="col-25">
              <label for="kaporasozimzali" style="font-weight:bolder">Fatura Yükle *</label>
              <br>
            </div>
            <div class="col-75">
             <input type="file" name="kaporafat" id="kaporafat" class="custom-file-input" accept=".pdf,.jpg,.png" required="required"> 
            </div>
          </div>
          <br>
           <br>
            <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Onayla ve Faturayı Yükle">
          </div>
        </form> 
...
<script>
       ...
       function validatecallForm()  {
          ...
          let fileInput = document.getElementById('kaporafat');
...
//alert(fileType);
      ...
      if (fileType === "application/pdf") {
        ...
        tapuyer=file.name + " dosyası desteklenmeyen bir türdedir.";
            document.getElementById('kaporafat').focus();
      }
