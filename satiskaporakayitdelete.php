...
<script>
     function opensession(){
        window.location.href = "https://whitelotustest.online/satiskaporakayityonet.php";
    }
                   function anamenu(){
         window.location.href = "https://whitelotustest.online/satiskaporakayityonet.php";
    }
...
//echo "Connected successfully";
  ...
  if($satildi){
   ...
   exit();   
    ...
    if($satisaayrildi){
   echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk satışa ayrılmıştır. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
   mysqli_close($conn);            
   exit();   
  }  
    
     if($kirayaayrildi){
   echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk kira için ayrılmıştır. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
   mysqli_close($conn);            
   exit();   
  }  
...
//echo "Connected successfully"; 
       ...
       $sql = "UPDATE satiskaporakayit SET isdeleted=1 where id='$buserid'"; 
    
              
     if ($conn->query($sql) === TRUE) {
         
         $sql = "UPDATE mulkkayit SET satiskaporaeklendi=0 where id='$mulknoid'"; 
