...
<h1 class="top-text">NOTICE ONAY</h1>
<!-------------------------------------------------------->
 ...
 include_once("config2.php");
    ...
    $empSQL = "SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted!=1 AND noticeverildimi=1";  
