...
//echo "Connected successfully";
  ...
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
        ...
        $imzali_path =$row['yonetimsozimzalipath'];
        $id=$row['id'];
}
...
<br>
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">İMZALI YÖNETİM SÖZLEŞMESİ YÜKLEME SAYFASI</label>
    ...
    echo '<br>';
    echo "<br><br>";           
    echo '<div class="makememiddlebody"><div class="containercap"><div class="textcapdiv"><form action='.$full_path.' method="get" enctype="multipart/form-data" target="_blank">
  <div class="row" id="hiderow">
  <button type="submit" id="autoClickBtn" class="gobackcap" style="background:green;color:white;font-size:15px;font-weight:bolder;">Yönetim Sözleşmesini İndir (PDF)</button>
   </form>
  </div></div>
  </div></div>
</form>';
          ...
          <form  id="busers" action="/yonetimsozyukleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"> 
          
          <input type="text" name="kirakaporasonkey" id="kirakaporasonkey" value="<?php echo $kirakaporasonkey;?>" style="display:none;"> 
          <input type="text" name="mulkno" id="mulkno" value="<?php echo $mulknoid;?>" style="display:none;">
          
          <div class="row">
            <div class="col-25">
              <label for="yonetimsozimzali" style="font-weight:bolder">İmzalı Yönetim Sözleşmesi *</label>
              <br>
            </div>
            <div class="col-75">
             <input type="file" name="yonetimsozimzali" id="yonetimsozimzali" class="custom-file-input" accept=".pdf,.jpg,.png" required="required"> 
            </div>
          </div>
          <br>
           <br>
            <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Onayla ve Yönetim Sözleşmesini Yükle">
          </div>
        </form> 
      ...
      <?php
         if($imzali_path!=""){ 
       echo '<form  id="busers2" action="/yonetimsozgoraction.php" method="post" enctype="multipart/form-data" target="_blank"> 
          
          <input type="text" name="kirakaporasonkey" id="kirakaporasonkey" value="'.$kirakaporasonkey.'" style="display:none;"> 
          <input type="text" name="mulkno" id="mulkno" value="'.$mulknoid.'" style="display:none;">

          <br>
           <br>
            <div class="row">
            <input type="submit" name="submit" id="onaybutton" style="background-color:blue;" value="İmzalı Yönetim Sözleşmesini Gör">
          </div>
        </form>';
         }
       ?>
...
<script>
       ...
       function validatecallForm()  {
          ...
          let fileInput = document.getElementById('yonetimsozimzali');
...
//alert(fileType);
      ...
      if (fileType === "application/pdf") {
        ...
        tapuyer=file.name + " dosyası desteklenmeyen bir türdedir.";
            document.getElementById('yonetimsozimzali').focus();
      }
