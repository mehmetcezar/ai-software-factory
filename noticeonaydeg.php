...
$pageid="noticeonay"; //hangi sayfa olduğu belirtilir. kullanıcıların hangi sayfalara erişeceği burdan ayarlanır.  
...
$kirabitistarihi=$row['kirabitistarihi'];
 $noticeaciklama=$row['noticeaciklama'];     
}
...
if ($result = $conn -> query("SELECT * FROM kirakaporakayit where  kirakaporakayit.company_id = '{$_SESSION['company_id']}' AND kirakaporakayit.isdeleted !=1 AND kirakaporakayit.kirakey='$kirakaporasonkey'")) {
  ...
  $result -> free_result();
    ...
    if ($noticeverildimi != 1) {
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülkteki kiralama için notice tarihi yetkili onayında değildir. Yetkili onayının sonuçlandırılması gerekir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülkteki kiralama için notice onaylanmıştır. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    ...
    <div class="options">
      <div class="container">
            ...
            <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">NOTICE ONAY SAYFASI</label>
           ...
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">NOTICE BİLGİLERİ</label>
        ...
        <label style="color:red;">Kiralama sorumlusu notice açıklaması:</label>
         <textarea class="form-control" maxlength="1000" id="metinAlani" oninput="adjustRows()" readonly><?php echo $noticeaciklama; ?></textarea>
          </div>
         <br>
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Mevcut Kira Sonlanma Tarihi </label>
            </div>
            <div class="col-75">
              <input type="date" id="kirabitistarihi" name="kirabitistarihi" value="<?php echo $kirabitistarihi;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col-25">
              <label for="kaporaiptaltarihi" style="font-weight:bolder"> Notice İle Gerçekleşecek Kiralama Sonlanma Tarihi </label>
            </div>
            <div class="col-75">
              <input type="date" id="noticetarihi" name="noticetarihi" readonly style="background-color:#DCDCDC;" value="<?php echo $noticetarihi;?>">
            </div>
          </div>
          <hr>
...
<div class="parentmain2">
   ...
   <form action="noticeonaydegaction.php" method="post" onsubmit="return validatecallForm()" name="formgun" id="formgun"><input type="text" id="mulkno" name="mulkno" style="display:none" value='.$mulkno.'>
   ...
   <div class="form-group">
      ...
      <input type="submit" name="submit" id="buttongun" style="float:left;background:red;margin-top:40px;font-size:16px;" value="Notice Tarihini Reddet"></form>
      
      
      
       <form name="formgun" id="formgun" action="noticeonaydegactionok.php" method="POST" onsubmit="return validatecallForm2()" enctype="multipart/form-data">
     
     <input type="text" id="mulkno" name="mulkno" style="display:none" value='.$mulkno.'>
   <input type="text" id="kirakaporasonkey" name="kirakaporasonkey" style="display:none" value='.$kirakaporasonkey.'>
      
 
      <input type="submit" name="submit" id="buttongun" style="float:right;background:green;margin-top:40px;font-size:16px;" value="Notice Tarihini Onayla">
    </form>
