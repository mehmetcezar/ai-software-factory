...
<div class="row" id="hiderow">
  <input name="iptal" type="submit" id="iptal" value="İptal Et Kiralama Portalına Dön" onclick="anamenu()" style="background:red;"/>
    ...
    /***KİRALAMA STATUS****/
      ...
      $kirayaayrildi=0; // onaylanmış olduğunda muhasebe tarafından 2 olur.
      $sql = "UPDATE mulkkayit SET kirayaayrildi='$kirayaayrildi', kirayaayrildisondate='', kirayaayrildisontime='', status='$status' where mulkkayit.id='$mulkno'";
 ...
 if ($conn->query($sql) === TRUE) {
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>'.$mulkno.' numaralı mülk için rezervasyon iptal edilmiştir. </p></div>
