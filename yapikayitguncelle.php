    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">YAPI KAYIT GÜNCELLEME</label>
              
               
              
          </div>
        <form  id="busers" action="/yapikayitguncelleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
         
         <input type="number" id="yapino" name="yapino" class="form-control"   value="<?php echo $yapino;?>" required="required" style="display:none;">
          ...
          <div class="row">
            ...
            <div class="col-75">
             ...
             <input type="text" name="mahalle" class="form-control" id="searchmi" oninput="handleInputChangemi();" onkeyup="handleInputDeletionmi();" onclick="this.select();" title="Sadece harf ve bazı özel karakterler girilebilir." autocomplete="off" onchange="changecolor();" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="80" value="<?php echo $mahalle;?>">
        ...
        <br> 
            ...
            <div class="col-75">
              <div id="inputFieldsContainer">
             <input type="text" name="sokak" class="form-control" id="searchmii" oninput="handleInputChangemii();" onkeyup="handleInputDeletionmii();" onclick="this.select();" title="Sadece harf ve bazı özel karakterler girilebilir." autocomplete="off" onchange="changecolor();" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="80" value="<?php echo $sokak;?>">
        ...
        <br> 
           ...
           <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="projeadi" name="projeadi" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="80" title="Sadece harf ve bazı özel karakterler girilebilir."  value="<?php echo $projeadi;?>">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="siteadi" name="siteadi" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="80" title="Sadece harf ve bazı özel karakterler girilebilir."  value="<?php echo $siteadi;?>" required="required">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
               <select name="yonetimsozlesmesi" id="yonetimsozlesmesi" class="form-control" required="required">
                  <option><?php echo $yonetimsozlesmesi;?></option>
                  <option>EVET</option>
                  <option>HAYIR</option>
              </select>
            </div>
           ...
           <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="blok" name="blok" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="80" title="Sadece harf ve bazı özel karakterler girilebilir."  value="<?php echo $blok;?>" required="required">
            </div>
          </div>
          <br>
           <br>
           ...
           <hr>
            ...
            <div class="col-75">
              <input type="number" id="kat" name="kat" class="form-control" min="0" step="1" max="100"  value="<?php echo $kat;?>" required="required">
            </div>
          </div>
             <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="kapino" name="kapino" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="20" title="Sadece harf ve bazı özel karakterler girilebilir." value="<?php echo $kapino;?>" required="required">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
               <select name="mulktip1" id="mulktip1" class="form-control" required="required">
                  <option><?php echo $mulktip1;?></option>
                  <option>Villa</option>
           ...
           <div class="row">
            ...
            <div class="col-75">
               <select name="mulktip2" id="mulktip2" class="form-control" required="required">
                  <option><?php //echo $mulktip2;?></option>
            ...
            <div class="col-75">
              <input type="number" id="postakodu" name="postakodu" class="form-control" min="0" step="1" max="99999999"  value="<?php echo $postakodu;?>" required="required">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="number" id="alan" name="alan" class="form-control" min="0" step="1" max="10000"  value="<?php echo $alan;?>" required="required">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="number" id="salonadet" name="salonadet" class="form-control" min="0" step="1" max="100"  value="<?php echo $salonadet;?>" required="required">
            </div>
          </div>
           <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="number" id="odaadet" name="odaadet" class="form-control" min="0" step="1" max="1000"  value="<?php echo $odaadet;?>" required="required">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="number" id="banyoadet" name="banyoadet" class="form-control" min="0" step="1" max="100"  value="<?php echo $banyoadet;?>" required="required">
            </div>
          </div>
            <br>
            <br>
          <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Onayla ve Yapıyı Güncelle">
          </div>
        </form>
        <br>
         <form  id="xxx" action="/yapikayityonet.php" method="post">
         <div class="row">
            <input type="submit" name="submit" id="xxxxx" style="background-color:red;" value="İptal Et ve Menüye Dön">
          </div>
          </form>
