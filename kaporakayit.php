...
//echo "Connected successfully";
    ...
    if ($result = $conn -> query("SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted !=1 AND (mulkkayit.satiskaporaeklendi!=1 || mulkkayit.kirakaporaeklendi!=1) AND mulkkayit.satildi!=1" )) {
...
*/
 ...
 <div class="button-container">
      ...
      <button id="showButton" onclick="toggleFields()" class="button">Mülk Numarası ile Kapora Ekleme</button>
    <div id="hiddenFields" style="display:none;">
        <!--<input type="text" name="extraInput" placeholder="Müşteri Seç..">
        <button type="submit">Gönder</button>-->
        <form method="POST" action="kaporakayitgir.php" onsubmit="return validatecallForm()" enctype="multipart/form-data">
        ...
        <br>
             ...
             <button id="renkdegis1" type="submit" class="button" style="background-color:#536DFE;display:none;">Kapora Kaydını Başlat</button>
              </div>
            </div>
        </div>
       ...
       <a href="kirakaporakayityonet.php" class="button">Kira Kapora Kayıt Listeleme/Güncelleme/Silme</a>
       <a href="satiskaporakayityonet.php" class="button">Satış Kapora Kayıt Listeleme/Güncelleme/Silme</a>
