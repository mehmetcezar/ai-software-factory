...
//echo "Connected successfully";
    ...
    if ($result = $conn -> query("SELECT * FROM mulkkayit where mulkkayit.isdeleted !=1 AND (mulkkayit.satiskaporaeklendi!=1 || mulkkayit.kirakaporaeklendi!=1) AND mulkkayit.satildi!=1" )) {
