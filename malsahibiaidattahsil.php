...
*/
 ...
 <div class="button-container">
    ...
    <div id="hiddenFields3" style="display:none;">
        ...
        <form method="POST" action="malsahibiaidattahsiletpre.php" onsubmit="return validatecallForm()" enctype="multipart/form-data">
        ...
        <br>
            ...
            <!-- Yıl seçimi için select ekliyoruz 
<label for="year" style="font-size:15px;padding: 0px 0px 0px 7px;">Yıl Seçiniz:</label>
<div style="padding: 0px 0px 0px 7px;">
    <select name="year" id="yearSelect" onchange="validateFormFields()" required>
        <option value="" selected disabled>Yıl Seçiniz</option>
        <script>
            // 2000-2100 yılları arasında seçenekler oluşturuluyor
            for (var year = 2020; year <= 2070; year++) {
                document.write('<option value="' + year + '">' + year + '</option>');
            }
        </script>
    </select>
</div>
<br><input type="text" id="yearid" name="yearx" style="display:none">
        -->    
...
<script>
    /*
      function validateFormFields() {
        ...
        var siteInput = document.getElementById("searchmiii").value;
        var submitButton = document.getElementById("renkdegis3");

        // Hem site adı hem yıl seçilmişse buton aktif olsun
        if (siteInput.trim() !== "" && yearSelect !== "") {
            submitButton.style.display = "block";
            document.getElementById("yearid").value=yearSelect;
        } else {
