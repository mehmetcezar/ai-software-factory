...
<br>
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">İMZALI SATIŞ SÖZLEŞMESİ YÜKLEME SAYFASI</label>
  ...
  <button type="submit" id="autoClickBtn" class="gobackcap" style="background:green;color:white;font-size:15px;font-weight:bolder;">Kapora Sözleşmesini İndir</button>
          ...
          <form  id="busers" action="/satiskaporasozkayitaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"> 
          ...
          <div class="row">
            <div class="col-25">
              <label for="kaporasozimzali" style="font-weight:bolder">İmzalı Satış Kaporası Sözleşmesi *</label>
              <br>
            </div>
            <div class="col-75">
      ...
      <?php
         if($imzali_path!=""){ 
       echo '<form  id="busers2" action="/satiskaporasozgoraction.php" method="post" enctype="multipart/form-data" target="_blank"> 
          ...
          <br>
           <br>
            <div class="row">
            <input type="submit" name="submit" id="onaybutton" style="background-color:blue;" value="İmzalı Satış Kaporası Sözleşmesini Gör">
          </div>
        </form>';
         }
       ?>
