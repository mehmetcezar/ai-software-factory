...
$internetodemebicimi = $row['internetodemebicimi'];       
 ...
 //echo $kirakaporaeklendi; 
        if ($cronjobiptalkapora == 1) {
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Kapora düşmüştür. Değerlendirilmek üzere yetkili onayındadır. Kiralama sürecini başlatmak için kaporanın yetkili tarafından değerlendirilmiş ve sonuçlandırılmış olması gerekir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    
    
if($kiralamaonayinda==1){
    echo "<br>";
    echo "<br>";
    echo '
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>Bu mülk kiralama onayındadır. Mevcut kiralama süreci silinmeden yeni kiralama süreci başlatılamaz.</p></div>
...
if($kaporaonayinda==1){
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>Bu mülk kapora alımına yönelik Yönetici onayındadır. Kapora süreci tamamlanmadan kiralama süreci başlatılamaz.</p></div>
  ...
  <input name="iptal" type="submit" id="iptal" value="Kiralama Portalına Dön" onclick="anamenu()" style="background:red;"/>
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>Kaporanın tamamı tahsil edilmemiştir. Öncelikle eksik tahsilatı tamamlayınız. Kapora tahsilat süreci tamamlanmadan kiralama süreci başlatılamaz.</p></div>
...
<br>
    ...
    <div class="options">
      <div class="container"> 
          ...
          <br>
            <br>
        <form  id="busers" action="/kiralamayapaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
       ...
       <!-- <input type="hidden" id="ilktaksitmiktari" name="ilktaksitmiktari">-->
          ...
          <div class="row">
           ...
           <div class="row">
            ...
            <div class="col-75">
               <input type="date" id="kiralamatarihi" name="kiralamatarihi" style="font-weight:bolder" required="required" min="<?php echo date('Y-m-d'); ?>">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="kirabedeli" name="kirabedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." value="<?php echo $kirabedeli;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
           <div class="row">
         ...
         $kiraodemebicimiyazi="HER ONİKİ AYDA BİR";
          ...
          <div class="dosya-alani5" style="display:none;">
           <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="komisyonbedeli" name="komisyonbedeli" class="form-control" value="<?php echo $komisyonbedeli;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
          <div class="row">
          ...
          <div class="dosya-alani6" style="display:none;">
           <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="aidatbedeli" name="aidatbedeli" class="form-control" value="<?php echo $aidatbedeli;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
          <div class="row">
...
echo '<a href="?dosya='.$ekbelgeyuklex.'">Dosyayı İndir</a>';
    ...
    $counter++;
          ...
          <div class="row">
            <div class="col-25">
              <label for="kaporakirabelge" style="font-weight:bolder">Kapora Belge *</label>
              <br>
            </div>
               <div class="col-75">
                             <?php 
...
echo '<a href="?dosya='.$kaporakirabelgeektahsilx.'">Dosyayı İndir</a>';
    ...
    $counter++;
          ...
          <div class="button-like-div" id="toggleButton2">Yapı/Mülk/Kapora Bilgilerini Göster/Gizle</div>
            ...
            <div class="row">
            <div class="col-25">
              <label for="kaporatahsilatmik" style="font-weight:bolder">Kapora Tahsilat Miktarı * </label>
            </div>
            <div class="col-75">
             <input type="text" id="kaporatahsilatmik" name="kaporatahsilatmik" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." required="required">
            </div>
            </div>
            <div class="row">
            <div class="col-25" >
              <label for="kaporaparabirimi" style="font-size:14px;font-weight:bolder">Para Birimi </label>
            <div class="col-75" style="max-width:250px;">
             <select name="kaporatahsilatmikpb" id="kaporatahsilatmikpb" class="form-control" onchange="handleCurrencyChange(); calculateSterling()">
                  <option></option>
                  <option>TL</option>
                  <option>EURO</option>
                  <option>DOLAR</option>
            ...
            <div id="exchangeFields" class="hidden">
                <div class="row">
                    <div class="col-25">
                        <label for="tlRate" style="font-weight:bolder">TL'den Sterlin'e Çevirim Oranı</label>
                    </div>
                    <div class="col-75">
                        <input type="number" id="tlRate" class="form-control" step="0.0001" placeholder="Örn: 0.035" oninput="calculateSterling()" required>
                    </div>
                </div>
                <div class="row" id="extraRateFields" class="hidden">
                    <div class="col-25">
                        <label id="toTlRateLabel" style="font-weight:bolder"></label>
                    </div>
                    <div class="col-75">
                        <input type="number" id="toTlRate" class="form-control" step="0.0001" placeholder="Örn: 25" oninput="calculateSterling()" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-25">
                    <label for="calculatedSterling" style="font-weight:bolder">Hesaplanan Sterlin Değeri (GBP)</label>
                </div>
                <div class="col-75">
                    <input type="text" id="calculatedSterling" class="form-control calculated" readonly style="background-color:#DCDCDC;">
                </div>
            </div>
            <div class="row">
            <div class="col-25">
              <label for="kaporatahsilatbelge" style="font-weight:bolder">Kapora Belge *</label>
              <br>
              <label for="kaporatahsilatbelge" style="font-size:11px;font-weight:bolder">Birden Fazla Dosya CTRL ile seçilebilir.</label>
            </div>
            <div class="col-75">
             <input type="file" name="kkaporatahsilatbelge[]" id="kaporatahsilatbelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles10(this)" required="required">
             <br><div id="fileNames10"></div> 
            </div>
          </div>
          <hr>
           ...
           <!-- 
            ...
            <div id="kaporaSection">
                <div class="row">
                    ...
                    <div class="col-75"><input type="text" id="kaporaMiktar" name="kaporaMiktar" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." oninput="calculateSterling('kapora')"></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-75"><select id="kaporaPB" name="kaporaPB" class="form-control" onchange="handleCurrencyChange('kapora'); calculateSterling('kapora')">
                        <option></option><option>TL</option><option>EURO</option><option>DOLAR</option><option>STERLIN</option></select></div>
                </div>
                <div id="kaporaExchangeFields" class="hidden">
                    <div class="row">
                        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
                        <div class="col-75"><input type="number" id="kaporaTlRate" name="kaporaTlRate" class="form-control" step="0.0001" placeholder="Örn: 0.035" oninput="calculateSterling('kapora')"></div>
                    </div>
                    <div class="row hidden" id="kaporaExtraRateFields">
                        <div class="col-25"><label id="kaporaToTlRateLabel"></label></div>
                        <div class="col-75"><input type="number" id="kaporaToTlRate" name="kaporaToTlRate" class="form-control" step="0.0001" placeholder="Örn: 25" oninput="calculateSterling('kapora')"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25"><label for="kaporaSterling">Hesaplanan Sterlin Değeri (GBP)</label></div>
                ...
                <div class="row">
                    <div class="col-25"><label for="kaporaBelge">Kapora Belge *</label><small> (Birden Fazla Dosya CTRL ile seçilebilir)</small></div>
                    <div class="col-75"><input type="file" name="kaporaBelge[]" id="kaporaBelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles('kapora')"><br><div id="kaporaFileNames"></div></div>
                </div>
            </div>
            -->
            <hr>
            ...
            <div class="row">
             ...
             <div class="row">
                    <div class="col-25"><label for="depozitoBelge">Depozito Belge *</label><small> (Birden Fazla Dosya CTRL ile seçilebilir)</small></div>
                    <div class="col-75"><input type="file" name="depozitoBelge[]" id="depozitoBelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles('depozito')"><br><div id="depozitoFileNames"></div></div>
                </div>
            ...
            <div id="depozitoSection">
                <div class="row">
                    ...
                    <div class="col-75"><input type="text" id="depozitoMiktar" name="depozitoMiktar" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." oninput="calculateSterling('depozito')"></div>
                </div>
                <div class="row">
                ...
                <div id="depozitoExchangeFields" class="hidden">
                    <div class="row">
                        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
                        <div class="col-75"><input type="number" id="depozitoTlRate" name="depozitoTlRate" class="form-control" step="0.0001" placeholder="Örn: 0.035" oninput="calculateSterling('depozito')"></div>
                    </div>
                    <div class="row hidden" id="depozitoExtraRateFields">
                        <div class="col-25"><label id="depozitoToTlRateLabel"></label></div>
                        <div class="col-75"><input type="number" id="depozitoToTlRate" name="depozitoToTlRate" class="form-control" step="0.0001" placeholder="Örn: 25" oninput="calculateSterling('depozito')"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25"><label for="depozitoSterling">Hesaplanan Sterlin Değeri (GBP)</label></div>
            ...
            <div id="aidatSection">
                <div class="row">
                    <div class="col-25"><label for="aidatMiktar">Aidat Tahsilat Miktarı *</label><?php
    if($aidatodemebicimi==1){
         $aidatodemebicimiyazi="HER AY";
     } 
    if($aidatodemebicimi==3){
      ...
      if($aidatodemebicimi==6){
        ...
        if($aidatodemebicimi==12){
         $aidatodemebicimiyazi="HER ONİKİ AYDA BİR";
                        ...
                        echo '<small style="color:red;">'.'Onaylanmış Aidat Bedeli: '.$aidatbedeli.' '.$aidatbedeliparabirimi.' '.$aidatodemebicimiyazi.'</small>'; echo "<br>"; if($buayaidat=='HAYIR'){echo '<small style="color:red;">Bu ay için aidat tahsili yapılmayacak.</small>';}  ?></div>
                    <div class="col-75"><input type="text" id="aidatMiktar" name="aidatMiktar" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." oninput="calculateSterling('aidat')"></div>
                </div>
                <div class="row">
                ...
                <div id="aidatExchangeFields" class="hidden">
                    <div class="row">
                        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
                        <div class="col-75"><input type="number" id="aidatTlRate" name="aidatTlRate" class="form-control" step="0.0001" placeholder="Örn: 0.035" oninput="calculateSterling('aidat')"></div>
                    </div>
                    <div class="row hidden" id="aidatExtraRateFields">
                        <div class="col-25"><label id="aidatToTlRateLabel"></label></div>
                        <div class="col-75"><input type="number" id="aidatToTlRate" name="aidatToTlRate" class="form-control" step="0.0001" placeholder="Örn: 25" oninput="calculateSterling('aidat')"></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-25"><label for="aidatBelge">Aidat Belge *</label><small> (Birden Fazla Dosya CTRL ile seçilebilir)</small></div>
                    <div class="col-75"><input type="file" name="aidatBelge[]" id="aidatBelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles('aidat')"><br><div id="aidatFileNames"></div></div>
                </div>
            </div>
            <hr>
            ...
            <div id="kiraSection">
                <div class="row">
                    <div class="col-25"><label for="kiraMiktar">Kira Tahsilat Miktarı *</label><?php
     if($kiraodemebicimi==1){
         $kiraodemebicimiyazi="HER AY";
     } 
    if($kiraodemebicimi==3){
      ...
      if($kiraodemebicimi==6){
        ...
        if($kiraodemebicimi==12){
         $kiraodemebicimiyazi="HER ONİKİ AYDA BİR";
                    ...
                    <div class="col-75"><input type="text" id="kiraMiktar" name="kiraMiktar" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." oninput="calculateSterling('kira')"></div>
                </div>
                <div class="row">
                ...
                <div id="kiraExchangeFields" class="hidden">
                    <div class="row">
                        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
                        <div class="col-75"><input type="number" id="kiraTlRate" name="kiraTlRate" class="form-control" step="0.0001" placeholder="Örn: 0.035" oninput="calculateSterling('kira')"></div>
                    </div>
                    <div class="row hidden" id="kiraExtraRateFields">
                        <div class="col-25"><label id="kiraToTlRateLabel"></label></div>
                        <div class="col-75"><input type="number" id="kiraToTlRate" name="kiraToTlRate" class="form-control" step="0.0001" placeholder="Örn: 25" oninput="calculateSterling('kira')"></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-25"><label for="kiraBelge">Kira Belge *</label><small> (Birden Fazla Dosya CTRL ile seçilebilir)</small></div>
                    <div class="col-75"><input type="file" name="kiraBelge[]" id="kiraBelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles('kira')"><br><div id="kiraFileNames"></div></div>
                </div>
            </div>
            <hr>
...
<script>
    ...
    /**
            ...
            const currency = document.getElementById("kaporatahsilatmikpb").value;
            const exchangeFields = document.getElementById("exchangeFields");
            const extraRateFields = document.getElementById("extraRateFields");
            const toTlRateLabel = document.getElementById("toTlRateLabel");
            ...
            if (currency === "STERLIN") {
                ...
                toTlRateLabel.innerText = "Euro'dan TL'ye Çevirim Oranı";
            } else if (currency === "DOLAR") {
                exchangeFields.classList.remove("hidden");
                extraRateFields.classList.remove("hidden");
                toTlRateLabel.innerText = "Dolar'dan TL'ye Çevirim Oranı";
            }
        }

        function calculateSterling() {
            const miktar = parseFloat(document.getElementById("kaporatahsilatmik").value);
            const currency = document.getElementById("kaporatahsilatmikpb").value;
            const tlRate = parseFloat(document.getElementById("tlRate").value);
            const toTlRate = parseFloat(document.getElementById("toTlRate").value || 1);

            if (!miktar || !tlRate || (currency !== 'TL' && !toTlRate && currency !== 'STERLIN')) {
                document.getElementById("calculatedSterling").value = "";
                return;
            }
            ...
            document.getElementById("calculatedSterling").value = sterlingValue.toFixed(2);
        }
     ...
     function showSelectedFiles10(input) {
        var fileNamesDiv = document.getElementById("fileNames10");
