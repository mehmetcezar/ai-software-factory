    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">ZARAR ZİYAN GİRİŞ SAYFASI</label>
    ...
    $counter++;
          ...
          <div class="row">
           ...
           <div class="row">
            ...
            <br>
          <hr>
        <form  id="busers" action="/zararziyangiraction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Zarar Ziyan Bilgilerini Giriniz.</label>
            </div>
          </div>
          <hr>
          ...
          <div class="row">
            <div class="col-25">
              ...
              <label for="zararziyanbedeli" style="font-size:11px;font-weight:bolder">Miktardan sonra para birimi istenecektir.</label>
            </div>
            <div class="col-75">
               <input type="text" id="zararziyanbedeli" name="zararziyanbedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." required="required">
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-75" style="max-width:250px;">
             <select name="zararziyanbedeliparabirimi" id="zararziyanbedeliparabirimi" class="form-control">
                  <option></option>
                  <option>TL</option>
                  <option>EURO</option>
                  <option>DOLAR</option>
         ...
         <div class="row">
            <div class="col-25">
              <label for="zararziyanbelge" style="font-weight:bolder">Zarar Ziyan Belge *</label>
              <br>
              <label for="zararziyanbelge" style="font-size:11px;font-weight:bolder">Birden Fazla Dosya CTRL ile seçilebilir.</label>
            </div>
            <div class="col-75">
             <input type="file" name="zararziyanbelge[]" id="zararziyanbelge" class="custom-file-input" accept=".pdf,.jpg,.png" multiple onchange="showSelectedFiles4(this)" required="required">
...
$('#zararziyanbedeli').change(function () {
      if ($(this).val() !== "") {
        $('.dosya-alani3').show();
          $('#zararziyanbedeliparabirimi').prop('required', true);
        ...
        $('.dosya-alani3').hide();
           $('#zararziyanbedeliparabirimi').prop('required', false);
    ...
    $('#zararziyanbedeli').trigger('change');   
