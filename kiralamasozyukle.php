...
//echo "Connected successfully";
  ...
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
        ...
        $full_path = $row['kiralamasozpdfpath'];
...
<br>
  ...
  <button type="submit" id="autoClickBtn" class="gobackcap" style="background:green;color:white;font-size:15px;font-weight:bolder;">Kira Sözleşmesini İndir (PDF)</button>
   </form>
  </div></div>
  </div></div>
</form>';
          ...
          <form  id="busers" action="/kiralamasozyukleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"> 
