...
//echo "Connected successfully";
  ...
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
        ...
        $full_path = $row['kaporasozpdfpath'];
        
        $imzali_path =$row['kaporasozimzalipath'];
        $id=$row['kirakey'];
}
  ...
  $result -> free_result();
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Kapora düşmüştür. Değerlendirilmek üzere yetkili onayındadır. Bu aşamada sözleşme girilemez. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}  
?>
...
<br>
  ...
  <button type="submit" id="autoClickBtn" class="gobackcap" style="background:green;color:white;font-size:15px;font-weight:bolder;">Kapora Sözleşmesini İndir (PDF)</button>
   </form>
  </div></div>
  </div></div>
</form>';
          ...
          <form  id="busers" action="/kirakaporasozkayitaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"> 
          ...
          <div class="row">
            <div class="col-25">
              <label for="kaporasozimzali" style="font-weight:bolder">İmzalı Kira Kaporası Sözleşmesi *</label>
              <br>
            </div>
            <div class="col-75">
             <input type="file" name="kaporasozimzali" id="kaporasozimzali" class="custom-file-input" accept=".pdf,.jpg,.png" required="required"> 
            </div>
          </div>
          <br>
           <br>
      ...
      <?php
         if($imzali_path!=""){ 
       echo '<form  id="busers2" action="/kirakaporasozgoraction.php" method="post" enctype="multipart/form-data" target="_blank"> 
          ...
          <br>
           <br>
            <div class="row">
            <input type="submit" name="submit" id="onaybutton" style="background-color:blue;" value="İmzalı Kira Kaporası Sözleşmesini Gör">
          </div>
        </form>';
         }
       ?>
...
<script>
       ...
       function validatecallForm()  {
          ...
          let fileInput = document.getElementById('kaporasozimzali');
...
//alert(fileType);
      ...
      if (fileType === "application/pdf") {
        ...
        tapuyer=file.name + " dosyası desteklenmeyen bir türdedir.";
            document.getElementById('kaporasozimzali').focus();
      }
