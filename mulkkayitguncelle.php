...
//echo "Connected successfully";
     ...
     if ($result = $conn -> query("SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted !=1 AND mulkkayit.id='$buserid'")) {
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
      ...
      $guncelaidat=$row['guncelaidat'];
        ...
        $maxkirainoran=$row['maxkirainoran'];
         $aidatsurekliligi=$row['aidatsurekliligi'];  
}
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">MÜLK GÜNCELLEME SAYFASI</label>
          ...
          <div class="row">
            ...
            <div class="col-75">
               <select name="yonetimsozlesmesi" id="yonetimsozlesmesi" class="form-control" readonly style="background-color:#DCDCDC;">
                  <option style="background-color:#DCDCDC;"><?php echo $yonetimsozlesmesi;?></option>
              </select>
            </div>
          </div>
           <div class="row">
          ...
          <br>
          <hr>
        <form  id="busers" action="/mulkkayitguncelleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Mülk Sahibi Bilgilerini Güncelleyiniz</label>
            </div>
          </div>
          <hr>
           <input type="text" id="yapino" name="yapino" class="form-control" value="<?php echo $yapino;?>" required="required" style="display:none;">
           
           <input type="text" id="mulkid" name="mulkid" class="form-control" value="<?php echo $mulkid;?>" required="required" style="display:none;">
            ...
            <div class="col-75">
               <select name="kiralamadurumu" id="kiralamadurumu" class="form-control" required="required">
                  <option><?php echo $kiralamadurumu;?></option>
                  <option>AÇIK</option>
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="adsoyad" name="adsoyad" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&* ]{1,80}" maxlength="80" title="Sadece harf ve bazı özel karakterler girilebilir." required="required" value="<?php echo $adsoyad;?>">
            </div>
          </div>
           <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="iletisim1" name="iletisim1" style="font-weight:bolder" required="required" maxlength="11" title="11 haneli olarak giriniz. 05XXXXXXXXX"  value="<?php echo $iletisim1;?>">
           ...
           <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="iletisim2" name="iletisim2" style="font-weight:bolder" maxlength="11" title="11 haneli olarak giriniz. 05XXXXXXXXX"  value="<?php echo $iletisim2;?>">
              <small class="form-text text-muted">
                11 haneli olarak giriniz. 05XXXXXXXXX
              </small>
            </div>
           ...
           <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="kimlikno" name="kimlikno" class="form-control" pattern="[A-Za-zöÖçÇşŞıIİğĞüÜ\s\/\\\-_.;:,?&*0-9 ]{1,80}" maxlength="30" title="Sadece harf ve bazı özel karakterler girilebilir." required="required"  value="<?php echo $kimlikno;?>">
            </div>
          </div>
           <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="email" name="email" style="font-weight:bolder" required="required" maxlength="40"  value="<?php echo $email;?>">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
             <textarea id="msozelnot" name="msozelnot" maxlength="500"><?php echo $msozelnot;?></textarea>  
            </div>
          </div>    
            <div class="row">
            <div class="col-25">
...
echo '<a href="?dosya='.$aktifkocanx.'">Dosyayı İndir</a>';
    ...
    $counter++;
echo '<br>';
echo 'Güncellenecek Dosyayı Yükle';    
echo ' <div class="form-group">
        <label>Aktif Koçan Dosyası:</label>
        <input type="file" name="aktifkocan" id="aktifkocan" class="custom-file-input" accept=".pdf,.jpg,.png">
        </div>';
          ...
          <hr>
           <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Diğer Mülk Bilgilerini Güncelleyiniz</label>
            </div>
          </div>
          <hr>
          <div class="row">
            ...
            <div class="col-75">
             <input type="text" id="kirabedeli" name="kirabedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir."  value="<?php echo $kirabedeli;?>" required="required">
            </div>
            </div>
            <div class="row">
            ...
            <div class="col-25">
              ...
              <br>
              <label for="guncelaidat" style="font-size:11px;font-weight:bolder">Miktardan sonra para birimi istenecektir.</label>
            </div>
            <div class="col-75">
             <input type="text" id="guncelaidat" name="guncelaidat" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir."  value="<?php echo $guncelaidat;?>" required="required">
            </div>
            </div>
            <div class="row">
            ...
            <div class="col-75" style="max-width:250px;">
             <select name="aidatsurekliligi" id="aidatsurekliligi" class="form-control" required="required">
                  <option><?php echo $aidatsurekliligi;?></option>
                  <option>EVET</option>
                  <option>HAYIR</option>
              </select>
            </div>
            ...
            <div class="col-75">
              <input type="number" id="maxkirainoran" name="maxkirainoran" class="form-control"  min="0" step="0.01" max="100"  value="<?php echo $maxkirainoran;?>" required="required">
            </div>
          </div>
            <hr>
           <div class="row">
...
echo '<br>';
echo '<div style="color:red;font-weight:bold;">Mevcut Dosyalar ile Birlikte Güncellenecek Dosyaları Yükle</div><br><label for="esyalistesi" style="font-size:11px;font-weight:bolder">Birden Fazla Dosya CTRL ile seçilebilir.</label><br>';    
echo ' <div class="form-group">
        <label>Eşya Listesi Dosyaları</label>
        <input type="file" name="esyalistesi[]" class="custom-file-input" accept=".pdf,.doc,.docx,.xls,.xlsx" multiple onchange="showSelectedFiles4(this)">
        <br>
...
echo '<div style="color:red;font-weight:bold;">Mevcut Dosyalar ile Birlikte Güncellenecek Dosyaları Yükle</div><br><label for="esyalistesi" style="font-size:11px;font-weight:bolder">Birden Fazla Dosya CTRL ile seçilebilir.</label><br>';    
echo ' <div class="form-group">
        <label>Ek Belge Dosyaları</label>
        <input type="file" name="ekbelgeyukle[]" class="custom-file-input" accept=".pdf,.doc,.docx,.xls,.xlsx" multiple onchange="showSelectedFiles4(this)">
        <br>
        <div id="fileNames4"></div>
        </div>';            
          ...
          <div class="row">
            ...
            <div class="col-75">
               <select name="susahiplik" id="susahiplik" class="form-control" required="required">
                  <option><?php echo $susahiplik;?></option>
          ...
          <div class="row">
            ...
            <div class="col-75">
               <select name="elektriksahiplik" id="elektriksahiplik" class="form-control" required="required">
                  <option><?php echo $elektriksahiplik;?></option>
                  <option>KİRACI</option>
                  <option>EV SAHİBİ</option>
                  <option>DİĞER</option>
              </select>
           ...
           <div class="row">
            ...
            <div class="col-75">
             <textarea id="mulkozelnot" name="mulkozelnot" maxlength="500"><?php echo $mulkozelnot;?></textarea>  
            </div>
          </div>
            <br>
            <br>
