...
document.getElementById("metinAlani").addEventListener("input", adjustRows);
          ...
          <br>
            <br>
        <form id="updateTahsilatForm" action="/tahsilatguncelleaction.php" method="post" enctype="multipart/form-data" onsubmit="return validatecallForm()">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <select name="tahsilatturu[]" id="tahsilatturu_<?php echo $i + 1; ?>" required>
                            <option value="KİRA" <?php echo $tahsilatTurleriArray[$i] === 'KİRA' ? 'selected' : ''; ?>>KİRA</option>
                            <option value="AİDAT" <?php echo $tahsilatTurleriArray[$i] === 'AİDAT' ? 'selected' : ''; ?>>AİDAT</option>
                            <option value="DEPOZİTO" <?php echo $tahsilatTurleriArray[$i] === 'DEPOZİTO' ? 'selected' : ''; ?>>DEPOZİTO</option>
                            <option value="KAPORA" <?php echo $tahsilatTurleriArray[$i] === 'KAPORA' ? 'selected' : ''; ?>>KAPORA</option>
                            <option value="SU" <?php echo $tahsilatTurleriArray[$i] === 'SU' ? 'selected' : ''; ?>>SU</option>
                            <option value="HİZMET" <?php echo $tahsilatTurleriArray[$i] === 'HİZMET' ? 'selected' : ''; ?>>HİZMET</option>
                            <option value="İNTERNET" <?php echo $tahsilatTurleriArray[$i] === 'İNTERNET' ? 'selected' : ''; ?>>İNTERNET</option>
                             <option value="KOMİSYON" <?php echo $tahsilatTurleriArray[$i] === 'KOMİSYON' ? 'selected' : ''; ?>>KOMİSYON</option>
                        </select>
                    </div>
                </div>
