...
<!--------------------------------MAİN------------------------------------->
 ...
 include_once("config2.php");
    ...
    $empSQL = "SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted!=1 AND mulkkayit.kirakaporaeklendi=1 AND mulkkayit.satiskaporaeklendi=1";  
