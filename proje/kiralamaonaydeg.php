...
<div id="kaporaSection">
    <div class="row">
        ...
        <?php
                        ...
                        echo '<small style="color:red;">'.'Onaylanmış Kapora Bedeli: '.$kaporamiktari.' '.$kaporaparabirimi.'</small>';  ?>
        </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
                <?php
                $veriler = [
                    "Kapora (£)"   => ["onaylanan" => $kaporabedeli, "edilen" => $kaporatahMiktar],
                ...
                $evraklar = [
                    "Kira Evrakları" => ["kira1.pdf", "kira2.pdf"],
                    "Kapora Evrakları" => ["kapora1.jpg"],
                    "Depozito Evrakları" => ["depozito1.pdf", "depozito2.pdf"],
                    "Aidat Evrakları" => ["aidat1.png", "aidat2.jpg"]
                ];
        ...
        <?php foreach ($evraklar as $kategori => $dosyalar) : ?>
            ...
            <ul class="evrak-listesi">
                <?php foreach ($dosyalar as $dosya) : ?>
                    <li><a href="uploads/<?= $dosya ?>" target="_blank"><?= $dosya ?></a></li>
                <?php endforeach; ?>
            </ul>
        <?php endforeach; ?>
    </div>
