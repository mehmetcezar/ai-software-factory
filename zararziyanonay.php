...
<h1 class="top-text">ZARAR-ZİYAN ONAY</h1>
<!-------------------------------------------------------->
 ...
 include_once("config2.php");
    ...
    $empSQL = "SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted!=1 AND zararziyangirildimi=1";  
