...
<script>
     function opensession(){
        window.location.href = "https://whitelotustest.online/kaporakayityonet.php";
    }
                   function anamenu(){
         window.location.href = "https://whitelotustest.online/kaporakayityonet.php";
    }
...
//echo "Connected successfully";
  ...
  if($satildi){
   echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk satılmıştır. Bu nedenle kapora kaydı değiştirilemez. Ana menüye dönmek için aşağıdaki butona tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
   mysqli_close($conn);            
   exit();   
  } 
