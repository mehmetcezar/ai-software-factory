...
<?php 
    ...
    <div class="options">
      <div class="container">
        ...
        <form  id="busers" action="/userscreateaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="bisim" style="font-weight:bolder">İsim *</label>
            </div>
            <div class="col-75">
              <input type="text" id="isim" name="isim" style="font-weight:bolder" required="required" pattern="[A-Za-zöÖçÇşŞıIğĞüÜ\s ]{1,30}" maxlength="30" title="Sadece harf girilebilir." value="<?php echo $_SESSION['bisim']; ?>">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
               <input type="text" id="soyisim" name="soyisim" style="font-weight:bolder" required="required" pattern="[A-Za-zöÖçÇşŞıIğĞüÜ\s ]{1,30}" maxlength="30" title="Sadece harf girilebilir." value="<?php echo $_SESSION['bsoyisim']; ?>">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
              <label for="bkullaniciadi" style="font-weight:bolder">Kullanıcı Adı*</label>
            </div>
            <div class="col-75">
              <input type="text" id="kullaniciadi" name="kullaniciadi" style="font-weight:bolder" required="required" pattern="[A-Za-z0-9.]{6,20}" maxlength="20" title="Sadece harf ve nokta girilebilir. Türkçe kararkterler kullanılamaz. En az 6 karakter girilmelidir.">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
              <label for="bsifre" style="font-weight:bolder">Şifre *</label>
            </div>
            <div class="col-75">
              <input type="text" id="sifre" name="sifre" style="font-weight:bolder" required="required" pattern="[A-Za-z0-9!-_.]{6,10}" maxlength="10" title="Sadece harf, sayı ve !-_. karakterleri girilebilir. En az 6 karakter girilmelidir.">
            </div>
          </div>
            <div class="row">
            <div class="col-25">
            ...
            <div class="row">
            <div class="col-25">
              <label for="kultipi" style="font-weight:bolder">Kullanıcı Tipi *</label>
            </div>
            <div class="col-75">
              <select id="kultipicreate" name="kultipicreate" required="required">
                <option><?php echo $_SESSION['kultipicreate']; ?></option>
                  <option>Yetkili</option>
                  <option>Kiralama Sorumlusu</option>
...
<script>
    ...
    function validatecallForm()  {
     let phone = document.forms["busers"]["bphone"].value;
        let email = document.forms["users"]["email"].value;
