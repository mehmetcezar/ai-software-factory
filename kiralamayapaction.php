...
$kiralamabitistarihi = $datetime->format('Y-m-d');    
     ...
     /*$sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi, toplamkirabedeli, kaporaid, ilktaksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, depozitovadesayisi, komisyon, komisyonbedeli, komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi, kiralamaozelnot, yetkilionay, muhasebeonay, status) VALUES ('', '$date','$uname','$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino','$mulkno','$stopajvergisi','$kirabedeli','$kirabedeliparabirimi','$kirasuresi','$kiraodemebicimi','$aidatodemebicimi','$toplamkirabedeli','$kaporaid','$ilktaksitmiktari','$depozitobedeli','$depozitobedeliparabirimi','$odenendepozito','$depozitovadesayisi','$komisyon','$komisyonbedeli','$komisyonbedeliparabirimi','$komisyontahsili', '$aidat','$aidatbedeli','$aidatbedeliparabirimi','$kiralamaozelnot','$yetkilionay', '$muhasebeonay','$status')";*/
    
   $sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi, toplamkirabedeli, kaporaid, taksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, komisyon, komisyonbedeli, komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi,aidatsontarih, yonetimsoziste,yonetimsozbastarih,yonetimsozbittarih, kiralamaozelnot, yetkilionay, muhasebeonay,kaporatahMiktar, kaporaPB, kaporaTlRate, kaporaToTlRate, kaporaSterling, depozitoMiktar, depozitoPB, depozitoTlRate, depozitoToTlRate, depozitoSterling, aidatMiktar, aidatPB, aidatTlRate, aidatToTlRate, aidatSterling, kiraMiktar, kiraPB, kiraTlRate, kiraToTlRate, kiraSterling, acente, buayaidat, subedeli, subedeliparabirimi, suodemebicimi, hizmetbedeli, hizmetbedeliparabirimi, hizmetodemebicimi, internetbedeli, internetbedeliparabirimi, internetodemebicimi, status) VALUES ('', '$date','$uname','$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino','$mulkno','$stopajvergisi','$kirabedeli','$kirabedeliparabirimi','$kirasuresi','$kiraodemebicimi','$aidatodemebicimi','$toplamkirabedeli','$kaporaid','$taksitmiktari','$depozitobedeli','$depozitobedeliparabirimi','$odenendepozito','$komisyon','$komisyonbedeli','$komisyonbedeliparabirimi','$komisyontahsili', '$aidat','$aidatbedeli','$aidatbedeliparabirimi','$aidatsontarih','$yonetimsoziste','$yonetimsozbastarih','$yonetimsozbittarih','$kiralamaozelnot','$yetkilionay', '$muhasebeonay', '$kaporatahMiktar', '$kaporaPB', '$kaporaTlRate', '$kaporaToTlRate', '$kaporaSterling', '$depozitoMiktar', '$depozitoPB', '$depozitoTlRate', '$depozitoToTlRate', '$depozitoSterling', '$aidatMiktar', '$aidatPB', '$aidatTlRate', '$aidatToTlRate', '$aidatSterling', '$kiraMiktar', '$kiraPB', '$kiraTlRate', '$kiraToTlRate', '$kiraSterling', '$acente', '$buayaidat', '$subedeli', '$subedeliparabirimi', '$suodemebicimi', '$hizmetbedeli', '$hizmetbedeliparabirimi', '$hizmetodemebicimi', '$internetbedeli', '$internetbedeliparabirimi', '$internetodemebicimi','$status')";
    
  
  
    
    
   //$sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi,toplamkirabedeli, kaporaid, taksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, komisyon, komisyonbedeli,komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi, aidatsontarih, yonetimsoziste, yonetimsozbastarih, yonetimsozbittarih, kiralamaozelnot, yetkilionay, muhasebeonay, status, kaporatahMiktar, kaporaPB, kaporaTlRate, kaporaToTlRate, kaporaSterling, depozitoMiktar, depozitoPB, depozitoTlRate, depozitoToTlRate, depozitoSterling, aidatMiktar, aidatPB, aidatTlRate, aidatToTlRate, aidatSterling, kiraMiktar, kiraPB, kiraTlRate, kiraToTlRate, kiraSterling) VALUES ('', '$date', '$uname', '$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino', '$mulkno', '$stopajvergisi', '$kirabedeli', '$kirabedeliparabirimi', '$kirasuresi', '$kiraodemebicimi', '$aidatodemebicimi', '$toplamkirabedeli', '$kaporaid', '$taksitmiktari', '$depozitobedeli', '$depozitobedeliparabirimi', '$odenendepozito', '$komisyon', '$komisyonbedeli', '$komisyonbedeliparabirimi', '$komisyontahsili', '$aidat', '$aidatbedeli', '$aidatbedeliparabirimi', '$aidatsontarih', '$yonetimsoziste', '$yonetimsozbastarih', '$yonetimsozbittarih', '$kiralamaozelnot', '$yetkilionay', '$muhasebeonay', '$status', '$kaporatahMiktar', '$kaporaPB', '$kaporaTlRate', '$kaporaToTlRate', '$kaporaSterling', '$depozitoMiktar', '$depozitoPB', '$depozitoTlRate', '$depozitoToTlRate', '$depozitoSterling', '$aidatMiktar', '$aidatPB', '$aidatTlRate', '$aidatToTlRate', '$aidatSterling', '$kiraMiktar', '$kiraPB', '$kiraTlRate', '$kiraToTlRate', '$kiraSterling')"; 
