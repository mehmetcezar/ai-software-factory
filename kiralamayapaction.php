...
$tarih2 = new DateTime($kiralamatarihi);
    
    if (!($tarih2>=$tarih1)) {
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Sisteme müdehale edilerek tarih değişikliği yapılmıştır. Kiralama kaydı yapılamaz. Ana menüye dönmek için tıklayınız. </z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
...
$kaporaidtekil = generateUniqueRandomString();// BAŞVURU TEKİLLİĞİNİ SAĞLAMAK   
 ...
 $kiralamakey=$kaporaidtekil;
  $kaporaid= $kaporaidtekil;     
    }
...
$kiralamabitistarihi = $datetime->format('Y-m-d');    
     ...
     $status="KIRAONAY"; //KIRAONAY: kira yetkili onayında, KIRADA: kira sürecinde; YENILENDI: süresi bitti ve yenilendi; KIRACIOUT: söz öncesinde kiracı ayrıldı; SONLANDI: söz. sonlandırıldı.
    
     /*$sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi, toplamkirabedeli, kaporaid, ilktaksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, depozitovadesayisi, komisyon, komisyonbedeli, komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi, kiralamaozelnot, yetkilionay, muhasebeonay, status, company_id) VALUES ('', '$date','$uname','$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino','$mulkno','$stopajvergisi','$kirabedeli','$kirabedeliparabirimi','$kirasuresi','$kiraodemebicimi','$aidatodemebicimi','$toplamkirabedeli','$kaporaid','$ilktaksitmiktari','$depozitobedeli','$depozitobedeliparabirimi','$odenendepozito','$depozitovadesayisi','$komisyon','$komisyonbedeli','$komisyonbedeliparabirimi','$komisyontahsili', '$aidat','$aidatbedeli','$aidatbedeliparabirimi','$kiralamaozelnot','$yetkilionay', '$muhasebeonay','$status', '{$_SESSION['company_id']}')";*/
    
   $sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi, toplamkirabedeli, kaporaid, taksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, komisyon, komisyonbedeli, komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi,aidatsontarih, yonetimsoziste,yonetimsozbastarih,yonetimsozbittarih, kiralamaozelnot, yetkilionay, muhasebeonay,kaporatahMiktar, kaporaPB, kaporaTlRate, kaporaToTlRate, kaporaSterling, depozitoMiktar, depozitoPB, depozitoTlRate, depozitoToTlRate, depozitoSterling, aidatMiktar, aidatPB, aidatTlRate, aidatToTlRate, aidatSterling, kiraMiktar, kiraPB, kiraTlRate, kiraToTlRate, kiraSterling, acente, buayaidat, subedeli, subedeliparabirimi, suodemebicimi, hizmetbedeli, hizmetbedeliparabirimi, hizmetodemebicimi, internetbedeli, internetbedeliparabirimi, internetodemebicimi, status, company_id) VALUES ('', '$date','$uname','$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino','$mulkno','$stopajvergisi','$kirabedeli','$kirabedeliparabirimi','$kirasuresi','$kiraodemebicimi','$aidatodemebicimi','$toplamkirabedeli','$kaporaid','$taksitmiktari','$depozitobedeli','$depozitobedeliparabirimi','$odenendepozito','$komisyon','$komisyonbedeli','$komisyonbedeliparabirimi','$komisyontahsili', '$aidat','$aidatbedeli','$aidatbedeliparabirimi','$aidatsontarih','$yonetimsoziste','$yonetimsozbastarih','$yonetimsozbittarih','$kiralamaozelnot','$yetkilionay', '$muhasebeonay', '$kaporatahMiktar', '$kaporaPB', '$kaporaTlRate', '$kaporaToTlRate', '$kaporaSterling', '$depozitoMiktar', '$depozitoPB', '$depozitoTlRate', '$depozitoToTlRate', '$depozitoSterling', '$aidatMiktar', '$aidatPB', '$aidatTlRate', '$aidatToTlRate', '$aidatSterling', '$kiraMiktar', '$kiraPB', '$kiraTlRate', '$kiraToTlRate', '$kiraSterling', '$acente', '$buayaidat', '$subedeli', '$subedeliparabirimi', '$suodemebicimi', '$hizmetbedeli', '$hizmetbedeliparabirimi', '$hizmetodemebicimi', '$internetbedeli', '$internetbedeliparabirimi', '$internetodemebicimi','$status', '{$_SESSION['company_id']}')";
    
  
  
    
    
   //$sql = "INSERT INTO kiralamakayit (id, date, username, kiralamakey, kiralamatarihi, kiralamabitistarihi, yapino, mulkno, stopajvergisi, kirabedeli, kirabedeliparabirimi, kirasuresi, kiraodemebicimi, aidatodemebicimi,toplamkirabedeli, kaporaid, taksitmiktari, depozitobedeli, depozitobedeliparabirimi, odenendepozito, komisyon, komisyonbedeli,komisyonbedeliparabirimi, komisyontahsili, aidat, aidatbedeli, aidatbedeliparabirimi, aidatsontarih, yonetimsoziste, yonetimsozbastarih, yonetimsozbittarih, kiralamaozelnot, yetkilionay, muhasebeonay, status, kaporatahMiktar, kaporaPB, kaporaTlRate, kaporaToTlRate, kaporaSterling, depozitoMiktar, depozitoPB, depozitoTlRate, depozitoToTlRate, depozitoSterling, aidatMiktar, aidatPB, aidatTlRate, aidatToTlRate, aidatSterling, kiraMiktar, kiraPB, kiraTlRate, kiraToTlRate, kiraSterling, company_id) VALUES ('', '$date', '$uname', '$kiralamakey', '$kiralamatarihi', '$kiralamabitistarihi','$yapino', '$mulkno', '$stopajvergisi', '$kirabedeli', '$kirabedeliparabirimi', '$kirasuresi', '$kiraodemebicimi', '$aidatodemebicimi', '$toplamkirabedeli', '$kaporaid', '$taksitmiktari', '$depozitobedeli', '$depozitobedeliparabirimi', '$odenendepozito', '$komisyon', '$komisyonbedeli', '$komisyonbedeliparabirimi', '$komisyontahsili', '$aidat', '$aidatbedeli', '$aidatbedeliparabirimi', '$aidatsontarih', '$yonetimsoziste', '$yonetimsozbastarih', '$yonetimsozbittarih', '$kiralamaozelnot', '$yetkilionay', '$muhasebeonay', '$status', '$kaporatahMiktar', '$kaporaPB', '$kaporaTlRate', '$kaporaToTlRate', '$kaporaSterling', '$depozitoMiktar', '$depozitoPB', '$depozitoTlRate', '$depozitoToTlRate', '$depozitoSterling', '$aidatMiktar', '$aidatPB', '$aidatTlRate', '$aidatToTlRate', '$aidatSterling', '$kiraMiktar', '$kiraPB', '$kiraTlRate', '$kiraToTlRate', '$kiraSterling', '{$_SESSION['company_id']}')"; 
    ...
    */
      $kiralamaonayinda=1;   
         $sql = "UPDATE mulkkayit SET kiralamaonayinda='$kiralamaonayinda', kirakaporasonkey='$kiralamakey', status='$status' where id='$mulkno'"; 
...
$total_count = count($kaporabelge); // Yüklenen dosyaların sayısını al

for ($i = 0; $i < $total_count; $i++) {
   
    
        $originalFileName = $kaporabelge[$i]; // Orijinal dosya adı
        ...
        // Dosya yükleniyor
        if (copy($originalFileName, $newFilePath)) {
...
if ($conn->query($sql) === TRUE) {
            ...
            echo "<br>";
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">'.$mulkno.' numaralı mülke başarıyla kiracı eklenmiş ve Yönetici onayına sunulmuştur. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>';  
