...
//echo "Connected successfully";
  ...
  $result -> free_result();
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülkteki kiralama için daha önce notice girilmiştir. yeni notice girilmesi için öncelikle eski girişin silinmesi gerekir.  Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">NOTICE GİRİŞ SAYFASI</label>
    ...
    $counter++;
          ...
          <div class="row">
           ...
           <div class="row">
            ...
            <br>
          <hr>
        <form  id="busers" action="/noticegiraction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Notice İçin Tarih Giriniz.</label>
            </div>
          </div>
          <hr>
          ...
          <div class="row">
            <div class="col-25">
              <label for="kirabitistarihi" style="font-weight:bolder">Mevcut Sözleşme Son Tarihi </label>
            </div>
            <div class="col-75">
              <input type="date" id="kirabitistarihi" name="kirabitistarihi" style="font-weight:bolder" value="<?php echo $datesession2;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
          <hr>
          <?php
            $datexxx = new DateTime(); // Mevcut tarihi al
$datexxx->modify('+1 day'); // 1 gün ekle
$nextDayxxx = $datexxx->format('Y-m-d'); // Tarihi formatla

            ?>
          
          <div class="row">
            <div class="col-25">
              <label for="noticetarihi" style="font-weight:bolder">Notice Tarihi *</label>
            </div>
            <div class="col-75">
              <input type="date" id="noticetarihi" name="noticetarihi" style="font-weight:bolder" required="required" max="<?php echo $datesession3; ?>" min="<?php echo $nextDayxxx; ?>">
            </div>
          </div>
          <hr>
            <br>
