...
//echo "Connected successfully";
 ...
 if ($result = $conn -> query("SELECT * FROM zararziyanreddet where zararziyanreddet.isdeleted !=1 AND zararziyanreddet.kirakey='$kaporaid'")) {
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">ZARAR_ZİYAN RED SEBEBİ</label>    
          </div>
          <hr>
                    <div style="color:red;">
     <?php
     
      echo "Yetkili aşağıdaki sebepten dolayı zarar ziyan girişini reddetti.";
    echo "<br>";
