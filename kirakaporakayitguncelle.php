...
//echo "Connected successfully";
  ...
  $result -> free_result();
         ...
         if ($result = $conn -> query("SELECT * FROM kirakaporakayit where  kirakaporakayit.company_id = '{$_SESSION['company_id']}' AND kirakaporakayit.isdeleted !=1 AND kirakaporakayit.id='$buserid'")) {
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KİRA KAPORA GÜNCELLEME SAYFASI</label>
...
echo '<a href="?dosya='.$ekbelgeyuklex.'">Dosyayı İndir</a>';
    ...
    $counter++;
         ...
         <form  id="busers" action="/kirakaporakayitguncelleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
          ...
          <hr>
           ...
           <input type="text" id="kaporatip" name="kaporatip" class="form-control" value="<?php echo "KİRALAMA";?>" required="required" style="display:none;">
           <div class="row">
           <div class="row">
            <div class="col-25">
...
echo '<br>';
echo '<div style="color:red;font-weight:bold;">Mevcut Dosyalar ile Birlikte Güncellenecek Dosyaları Yükle</div><br><label for="kaporakirabelge" style="font-size:11px;font-weight:bolder">Birden Fazla Dosya CTRL ile seçilebilir.</label><br>';    
