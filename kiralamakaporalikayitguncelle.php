    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KİRALAMA GÜNCELLEME SAYFASI- KAPORALI</label>
...
echo '<a href="?dosya='.$kaporakirabelgex.'">Dosyayı İndir</a>';
    ...
    $counter++;
          ...
          <br>
            <br>
        <form  id="busers" action="/kiralamakaporalikayitguncelleaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Kiralamaya Ait Bilgileri Güncelleyiniz</label>
            </div>
          </div>
          <hr>
           ...
           <input type="text" id="kiralamaid" name="kiralamaid" class="form-control" value="<?php echo $kiralamaid;?>" required="required" style="display:none;">
        ...
        <input type="hidden" id="ilktaksitmiktari" name="ilktaksitmiktari">
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="kirabedeli" name="kirabedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." required="required" value="<?php echo $kirabedeli;?>">
            </div>
          </div>
           <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="number" id="kirasuresi" name="kirasuresi" class="form-control" min="1" max="60" required="required" value="<?php echo $kirasuresi;?>">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
        ...
        if($kiraodemebicimi==12){
         $kiraodemebicimiyazi="HER ONİKİ AYDA BİR";
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="depozitobedeli" name="depozitobedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." required="required" value="<?php echo $depozitobedeli;?>">
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="odenendepozito" name="odenendepozito" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." required="required" value="<?php echo $odenendepozito;?>">
            </div>
          </div>
          ...
          <div class="dosya-alani5" style="display:none;">
           <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="komisyonbedeli" name="komisyonbedeli" class="form-control" pattern="\d+(\.\d{1,2})?" maxlength="20" title="Sadece sayı veya ondalık sayı girilebilir." value="<?php echo $komisyonbedeli;?>">
            </div>
          </div>
          <div class="row">
         ...
         <br>
          <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Onayla ve Kiralama Bilgilerini Güncelle">
          </div>
        </form>
