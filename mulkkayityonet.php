...
<?php 
    ...
    ?>
<h1 class="top-text">TANIMLANAN MÜLKLER</h1>
...
<!--------------------------------MAİN------------------------------------->
 ...
 include_once("config2.php");
    ...
    $empSQL = "SELECT * FROM mulkkayit where  mulkkayit.company_id = '{$_SESSION['company_id']}' AND mulkkayit.isdeleted!=1 AND mulkkayit.company_id = '{$_SESSION['company_id']}'";  
	...
	<tbody> 
		...
		?>
            ...
            echo '<form action="mulkgoster.php" method="post" name="form' . $emp['id'] . '" id="form' . $emp['id'] . '">';
            ...
            */
            ...
            echo '</td>';?>
                ...
                <td id="tdhide"><?php echo $emp['adsoyad']; ?></td> 
				...
				<td id="tdhide"><?php echo $emp['kirabedeli']." ".$emp['kirabedeliparabirimi']; ?></td> 
  ...
  <a href="#"><form action="mulkkayitguncelle.php" method="post" name="formgun" id="formgun"><input type="text" id="buserid" name="buserid" style="display:none" value='.$emp['id'].'><input type="submit" name="submit" id="buttongun" style="background:green;" value="Mülk Güncelle"></form></a>
  <a href="#"><form action="mulkkayitdelete.php" method="post" name="formgun" id="formgun"><input type="text" id="buserid" name="buserid" style="display:none" value='.$emp['id'].'><input type="submit" name="submit" id="buttongun" style="background:red;" value="Mülk Sil"></form></a>
  </div>
</div>                      
                                                   ';
