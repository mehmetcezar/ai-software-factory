...
<?php 
    ...
    ?>
<h1 class="top-text">TANIMLANAN KAPORALAR</h1>
...
<!--------------------------------MAİN------------------------------------->
 ...
 include_once("config2.php");
    ...
    $empSQL = "SELECT * FROM kaporakayit where kaporakayit.isdeleted!=1";  
	...
	<tbody> 
		...
		?>
			<tr> 
				...
				<td><?php echo $satiskapora; ?></td> 
				<td><?php echo $kirakapora; ?></td>    
                <td><?php
            echo '
  ...
  <a href="#"><form action="kaporakayitguncelle.php" method="post" name="formgun" id="formgun"><input type="text" id="buserid" name="buserid" style="display:none" value='.$emp['id'].'><input type="submit" name="submit" id="buttongun" style="background:green;" value="Kap. Güncelle"></form></a>
  <a href="#"><form action="kaporakayitdelete.php" method="post" name="formgun" id="formgun"><input type="text" id="buserid" name="buserid" style="display:none" value='.$emp['id'].'><input type="submit" name="submit" id="buttongun" style="background:red;" value="Kap. Sil"></form></a>
  </div>
</div>                      
                                                   ';
