...
<br>
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">İMZALI KİRA SÖZLEŞMESİ</label>
    ...
    echo '<br>';
    echo "<br><br>";           
    echo '<div class="makememiddlebody"><div class="containercap"><div class="textcapdiv"><form action='.$imzali_path.' method="get" enctype="multipart/form-data" target="_blank">
