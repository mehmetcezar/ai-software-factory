...
//echo "Connected successfully";
 ...
 if ($result = $conn -> query("SELECT * FROM noticereddet where noticereddet.isdeleted !=1 AND noticereddet.kirakey='$kaporaid'")) {
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">NOTICE RED SEBEBİ</label>    
          </div>
          <hr>
                    <div style="color:red;">
     <?php
     
      echo "Yetkili aşağıdaki sebepten dolayı notice tarihini reddetti.";
    echo "<br>";
