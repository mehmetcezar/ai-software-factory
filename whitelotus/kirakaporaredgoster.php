...
//echo "Connected successfully";
 ...
 if ($result = $conn -> query("SELECT * FROM kaporareddet where kaporareddet.isdeleted !=1 AND kaporareddet.kirakey='$kaporaid'")) {
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KİRA KAPORA RED SEBEBİ</label>    
          </div>
          <hr>
                    <div style="color:red;">
     <?php
     
      echo "Yetkili aşağıdaki sebepten dolayı kapora talebinizi reddetti.";
    echo "<br>";
