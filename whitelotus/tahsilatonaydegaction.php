...
<script src="js/bootstrap.min.js"></script>
 ...
 <script>
        ...
        window.location.href = "https://whitelotustest.online/tahsilatonay.php";
    }
    </script>
...
//echo "Connected successfully";
  ...
  if ($yetkilionay != 1) {
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu tahsilat yetkili onayında değildir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}  
...
//    $tarih = date('Y-m-d');
        ...
        $guncellemegonderildi=1; //0 yetkili onayında, 1  güncellemede
        //yetkilionayi: 1 yetkili onayında, 2 yetkili onayladı, 0 onayda değil 
         $sql = "UPDATE tahsilat SET guncellemegonderildi='$guncellemegonderildi', yetkiligunnot='$aciklama'  where id='$tahsilatid'"; 
         ...
         if ($conn->query($sql) === TRUE) {
            ...
            echo "<br>";
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">İncelemiş olduğunuz tahsilatlar güncellemeye gönderilmiştir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>';  
         }
         else 
{
