...
//echo "Connected successfully";
      ...
      $muhasebeonay=2; // onaylanmış olduğunda muhasebe tarafından 2 olur.
      $sql = "UPDATE kiralamakayit SET muhasebeonay='$muhasebeonay' where kiralamakayit.id='$buserid'";
    
 if ($conn->query($sql) === TRUE) {
     
     $kiralandi=1;
     $sql = "UPDATE mulkkayit SET mulkkayit.kiralandi='$kiralandi' where mulkkayit.id='$mulknoid'";
     
     

     echo "<br>";
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">'.$mulknoid.' numaralı mülkün kiralanması muhasebe onayından geçmiştir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Devam</button></div></div></div></div>'; 
