...
$newFilePath = $basePath.$projectId."_kirakap_".$currentDate.$i. "." . $fileExtension;
...
//echo "Connected successfully";
      ...
      $sql = "UPDATE kirakaporakayit SET kaporasozimzalipath='$kaporasozimzalipaths' where kirakaporakayit.kirakey='$buserid'";
