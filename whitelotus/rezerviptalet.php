...
<!-------------------------------------------------------->
<h1 class="top-text">REZERVASYON İPTAL SAYFASI</h1>
  ...
  $result -> free_result();
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>Bu mülk için rezervasyon iptali yapılamaz. Mülk kira sürecindedir.</p></div>
  ...
  <input name="iptal" type="submit" id="iptal" value="İptal Et Kiralama Portalına Dön" onclick="anamenu()" style="background:red;"/>
    ...
    <div class="options">
      <div class="container">   
            ...
            <div class="row"><p>Bu mülk için herhangi bir rezervasyon bulunmamaktadır.</p></div>
   ...
   <div class="parentmain2">
    <div class="options">
      <div class="container">   
            ...
            <form  id="aidatyapi" name="aidatyapi" action="/rezerviptaletaction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data"><div class="row"><p>Formu onaylamanız halinde bu mülke ait REZERVASYON İPTAL edilecektir.</p></div>

         <input type="text" id="mulkno" name="mulkno" style="display:none" value="<?php echo $mulkno;?>">
         
  <div class="row" id="hiderow">
  <input type="submit" name="aidatyapi" id="aidatyapi" value="Rezervasyonu İptal Et" style="background:red;">
  </div>
</form><br>
<div class="row" id="hiderow">
