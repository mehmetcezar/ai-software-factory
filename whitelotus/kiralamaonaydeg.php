...
<script src="js/bootstrap.min.js"></script>
 ...
 .avatar {
        ...
        .evrak-listesi { list-style-type: none; padding: 0; margin: 0; }
        .evrak-listesi li { margin-bottom: 5px; }
        .evrak-title { font-weight: bold; margin-top: 15px; }
        .icon { font-size: inherit; vertical-align: middle; }     
</style>     
...
$yonetimsozbittarihx = $tarihObjesi3->format('d-m-Y');
 ...
 if ($kiralamaonayinda != 1) {
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk kiralama onayında değildir. Ana menüye dönmek için tıklayınız. </z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    
    if ($kiralamaonayinda == 1 && $kiralamaguncellemegonderildi==1) {
       echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk kiralama onayından sonra güncellemeye gönderildi. Güncellenmesini bekleyiniz. Ana menüye dönmek için tıklayınız. </z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
    ...
    let lines = []; 
     let checkbit=0;           
      ...
      {line3="Kira Ödeme Biçimi: " + "Her Ay";
       ...
       {
        line11= "Aylık Belirlenmiş Kira Bedeli: " + document.getElementById("taksitmiktari").value + " "+kirabedeliparabirimi +"  "+"<span class='checkmark'>✔</span>";     
       }else
           {
            line11= "Aylık Belirlenmiş Kira Bedeli: " + document.getElementById("taksitmiktari").value + " "+kirabedeliparabirimi +"  "+"<span class='crossmark'>&cross;</span>";     
           }
      }
    ...
    <div class="options">
      <div class="container">
            ...
            <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KİRALAMA ONAY SAYFASI</label>
              
          </div>
          
           <div style="color:red;">
     <?php
     if($kiralamaonayinda==1 && $yetkiliaciklama!=NULL)
    echo "<br>";
...
document.getElementById("metinAlani").addEventListener("input", adjustRows);
       ...
       <!-- <input type="hidden" id="ilktaksitmiktari" name="ilktaksitmiktari">-->
          ...
          <div class="row">
            ...
            <div class="col-75">
               <input type="date" id="kiralamatarihi" name="kiralamatarihi" style="font-weight:bolder" readonly style="background-color:#DCDCDC;" value="<?php echo $kiralamatarihi; ?>">
            </div>
          </div>
           <div class="row">
            <div class="col-25">
      ...
      if($aidatodemebicimi==6){
        ...
        if($aidatodemebicimi==12){
         $aidatodemebicimiyazi="HER ONİKİ AYDA BİR";
                   ...
                   ?>
                  <option value="<?php echo $aidatodemebicimi;?>"><?php echo $kiraodemebicimiyazi;?></option>
              </select>
            </div>
          </div>
...
<div id="kaporaSection">
    <div class="row">
        <div class="col-25"><label for="kaporaMiktar">Kapora Tahsilat Miktarı</label>
        <?php
                 
                        
                        echo '<small style="color:red;">'.'Onaylanmış Kapora Bedeli: '.$topalkaporamiktari.' '.$kaporaparabirimi.'</small>';  ?>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-75"><input type="text" id="kaporaTlRate" name="kaporaTlRate" class="form-control" value="<?php echo htmlspecialchars($kaporaTlRate ?? ''); ?>" readonly></div>
    </div>
...
<div id="depozitoSection">
    <div class="row">
        <div class="col-25"><label for="depozitoMiktar">Depozito Tahsilat Miktarı</label>
        <?php

                        
                        
                        echo '<small style="color:red;">'.'Onaylanmış Depozito Bedeli: '.$depozitobedeli.' '.$depozitobedeliparabirimi.'</small>';  ?>
    ...
    <div class="row">
        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
        <div class="col-75"><input type="text" id="depozitoTlRate" name="depozitoTlRate" class="form-control" value="<?php echo htmlspecialchars($depozitoTlRate ?? ''); ?>" readonly></div>
    </div>
    <?php
    if($depozitoPB == 'EURO'){
      echo '<div class="row">
...
<div id="aidatSection">
      ...
      if($aidatodemebicimi==6){
        ...
        if($aidatodemebicimi==12){
         $aidatodemebicimiyazi="HER ONİKİ AYDA BİR";
                        ...
                        echo '<small style="color:red;">'.'Onaylanmış Aidat Bedeli: '.$aidatbedeli.' '.$aidatbedeliparabirimi.' '.$aidatodemebicimiyazi.'</small>'; echo "<br>"; if($buayaidat=='HAYIR'){echo '<small style="color:red;">Bu ay için aidat tahsili yapılmayacak.</small>';}  ?>
        </div>
    ...
    <div class="row">
        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
        <div class="col-75"><input type="text" id="aidatTlRate" name="aidatTlRate" class="form-control" value="<?php echo htmlspecialchars($aidatTlRate ?? ''); ?>" readonly></div>
    </div>
    <?php
    if($aidatPB == 'EURO'){
      echo '<div class="row">
...
<div id="kiraSection">
    ...
    <div class="row">
        <div class="col-25"><label>TL'den Sterlin'e Çevirim Oranı</label></div>
        <div class="col-75"><input type="text" id="kiraTlRate" name="kiraTlRate" class="form-control" value="<?php echo htmlspecialchars($kiraTlRate ?? ''); ?>" readonly></div>
    </div>
    <?php
    if($kiraPB == 'EURO'){
      echo '<div class="row">
...
echo '<a href="?dosya='.$kaporakirabelgeektahsilx.'">Dosyayı İndir</a>';
    ...
    <div class="options">
<div class="container">
    <h2 class="text-center mt-4">Finansal Durum Tablosu</h2>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
                <?php
                $veriler = [
                    "Kapora"   => ["onaylanan" => $topalkaporamiktari, "edilen" => $kaporatahMiktar],
                    "Depozito" => ["onaylanan" => $depozitobedeli, "edilen" => $depozitoMiktar], // Burada fark sıfır olacak
                    "Kira"     => ["onaylanan" => $kirabedeli, "edilen" => $kiraMiktar],
                    "Aidat"    => ["onaylanan" => $aidatbedeli, "edilen" => $aidatMiktar]
                ];

                $evraklar = [
                    "Kira Evrakları" => $kirabelgepathsayri,
                    "Kapora Evrakları" => $kaporabelgepathsayri,
                    "Depozito Evrakları" => $depozitobelgepathsayri,
                    "Aidat Evrakları" => $aidatbelgepathsayri
                ];

                foreach ($veriler as $kategori => $row) {
                    $fark = $row["onaylanan"] - $row["edilen"];
                    
                    if ($kategori === "Aidat" && $buayaidat === "HAYIR") {
                        $icon = "<span class='text-success icon'>&#9989; Bu Ay Yok</span>"; // Aidat bu ay tahsil edilmeyecek
                    } else {
                        $icon = $fark == 0 ? "<span class='text-success icon'>&#9989;</span>" : "<span class='text-danger icon'>&#10060;</span>";
                    }
    ...
    <div class="mt-4">
        <h4 class="text-center">Evrak Listesi</h4>
        <div class="row">
            <?php foreach ($evraklar as $kategori => $dosyalar) : ?>
                <div class="col-lg-4 col-md-6 col-12">
                    <p class="evrak-title"><?= $kategori ?>:</p>
                    <ul class="evrak-listesi">
                        <?php $j=1;  foreach ($dosyalar as $dosya) : ?>
                            <li><a href="<?= $dosya ?>" target="_blank">Dosya <?php echo $j; $j++; ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            <?php endforeach; ?>
...
<div class="parentmain2">
   ...
   <form action="kiralamaonaydegaction.php" method="post" onsubmit="return validatecallForm()" name="formgun" id="formgun"><input type="text" id="mulkno" name="mulkno" style="display:none" value='.$mulkno.'>
   ...
   <div class="form-group">
      ...
      <input type="submit" name="submit" id="buttongun" style="float:left;background:red;margin-top:40px;font-size:16px;" value="Kiralama Sorumlusuna Güncellemeye Gönder"></form>
       ...
       <form name="formgun" id="formgun" action="kiralamaonaydegactionok.php" method="POST" onsubmit="return validatecallForm2()" enctype="multipart/form-data">
     
     <input type="text" id="mulkno" name="mulkno" style="display:none" value='.$mulkno.'>
   <input type="text" id="kirakaporasonkey" name="kirakaporasonkey" style="display:none" value='.$kirakaporasonkey.'>
      
 
      <input type="submit" name="submit" id="buttongun" style="float:right;background:green;margin-top:40px;font-size:16px;" value="Onayla ve Kiralamayı Tamamla">
    </form>
