...
//echo "Connected successfully";
  ...
  while ($row = $result -> fetch_array(MYSQLI_ASSOC)) {
      ...
      if($row['kirakaporaeklendi']==1 && $row['kiracieklendi']!=1 && $row['kiralandi']!=1)
      {
        $kaporaison=0;
  ...
  $result -> free_result();
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Kapora düşmüştür. Değerlendirilmek üzere yetkili onayındadır. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Bu mülk üzerinde kapora bulunmamaktadır. Kapora uzatmak için öncelikle kapora eklemeniz gerekir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
   ...
   echo "<br>";
   echo "<br>";
       echo '<div class="parentmain2"><div class="options"><div class="container"><z class="textcap">Kapora süresinin uzatılması için yetkili onayındadır. Kapora süresini uzatmak için yetkili onay sürecinin tamamlanması gerekir. Ana menüye dönmek için tıklayınız.</z><div class="gobackcapdiv"><br><br><button class="gobackcap" type="submit" name="submit" onclick="opensession()">Ana Menü</button></div></div></div></div>';
   exit();
}
...
$datesession4 = $datetime->format('Y-m-d');
?>
    ...
    <div class="options">
      <div class="container"> 
           <div class="row">
              ...
              <label class="top-text" for="genelbilgi" style="font-weight:bolder;font-size:16px;">KAPORA SÜRE UZATMA SAYFASI</label>
    ...
    $counter++;
          ...
          <div class="row">
           ...
           <div class="row">
            ...
            <br>
          <hr>
        <form  id="busers" action="/kaporasureuzataction.php" method="post" onsubmit="return validatecallForm()" enctype="multipart/form-data">
          <div class="row">
            <div class="col-25">
              <label for="adresolustur" style="font-weight:bolder">Süre Uzatımı İçin Tarih Giriniz.</label>
            </div>
          </div>
          <hr>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="date" id="kaporateslimtarihi" name="kaporateslimtarihi" style="font-weight:bolder" value="<?php echo $datesession2;?>" readonly style="background-color:#DCDCDC;">
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col-25">
              <label for="kaporaiptaltarihi" style="font-weight:bolder">Kapora İptal Tarihi *</label>
            </div>
            <div class="col-75">
              <input type="date" id="kaporaiptaltarihi" name="kaporaiptaltarihi" style="font-weight:bolder" required="required" min="<?php echo $datesession3; ?>" max="<?php echo $datesession4; ?>">
            </div>
          </div>
          <hr>
            <br>
        ...
        <textarea class="form-control" id="aciklama" name="aciklama" maxlength="1000" required="required" oninput="adjustRows3()"></textarea>
         ...
         <br>
            <br>
          <div class="row">
            <input type="submit" name="submit" id="onaybutton" value="Yetkili Onayına Sun">
          </div>
        </form>
